<?php
/*
Child Theme Name: Boostrap 3 Template 
Author: Zopp Agency
Version: 0.01
URL: htp://www.zoppagency.com/

For more information, check the log.txt file.
*/
	
/************* REGISTER CHILD THEME (You can Change This) ******/
define( 'CHILD_THEME_NAME', 'oostrap 3 Template' );
define( 'CHILD_THEME_URL', 'http://www.zoppagency.com/' );
...
function bfg_theme_setup() {
	...
	*/
	// add_theme_support( 'genesis-footer-widgets', 3 );
	include_once( CHILD_DIR . '/library/zopp.php');
